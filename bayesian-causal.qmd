...
# the parent locale. Use SEPARATE input and output files so a failed
# subprocess can never leave the input list sitting where we expect the
# result, and check the exit status and object names before trusting it.
