...
plot(true_dag, nodeAttrs = node_attrs,
...
plot(amat_to_fciAlgo(amat_true_pag, n_obs), main = "True MAG")
plot(fci_fit,  main = "FCI — estimated PAG")
plot(rfci_fit, main = "RFCI — estimated PAG")
par(op)
```
