...
plot_ig <- function(g, main="", layout=NULL) {
  ...
  plot(g, layout=layout, main=main,
       vertex.size=22, vertex.color="white", vertex.frame.color="black",
...
all_labels <- as.character(1:n_vars)   # short labels so they fit inside pcalg's default node circles
