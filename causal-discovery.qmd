...
# Compact node labels for all DAG/CPDAG/PAG plots in this chapter.
plot_attrs <- list(
...
#| fig-width: 5
#| fig-height: 4
plot(true_dag, main = "", attrs = plot_attrs)
```
...
plot(true_dag,  main = "True DAG",                  attrs = plot_attrs)
plot(cpdag_pc,  main = "PC — estimated CPDAG",      attrs = plot_attrs)
plot(cpdag_ges, main = "GES — estimated CPDAG",     attrs = plot_attrs)
par(op)
```
