...
- With heterogeneous effects, IV estimates LATE. It should not be described
  as ATE unless extra assumptions justify that interpretation. The clean
  IV → LATE result here uses no covariates; once covariates are added
  linearly to TSLS, the LATE interpretation requires a *rich covariates*
  condition that is rarely defended. See the IV chapter section
  "When TSLS-with-Covariates Is *Actually* LATE" and Blandhol, Bonney,
  Mogstad & Torgovitsky (2025).
