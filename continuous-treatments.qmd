...
2. **Doubly-robust dose-response estimation** (Kennedy 2017), which combines
   a GPS with an outcome model.
...
Kennedy's estimator is the continuous-treatment analogue of AIPW. It
combines:
...
nearby observed doses contribute to the estimate.
...
Here is a simple policy that sets each treatment to zero:
...
an IPW estimate, and confidence intervals.
