...
The mpdta effects are real and therefore unknown. To see whether ETWFE recovers
what it should, we switch to simulated data where the answer is recorded in the
file.
