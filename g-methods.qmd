...
on covariate history. Stabilized weights usually have lower variance than
...
and treatment models and reports TMLE, IPTW, and g-computation estimates.
...
`ltmle` returns several estimates of $\mathbb{E}[Y(\bar a=1)]$ side by side,
which is useful for checking how much the answer depends on the model.
