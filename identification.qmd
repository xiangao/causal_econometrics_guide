...
Weaker Assumptions: Unconfoundedness (conditional independence, or ignorability): $$ E[Y(0) | W, X] = E[Y(0)| X] $$ Overlap: $$ 0 < \pi(x)= P(W=1 | X=x) < 1$$ SUTVA (stable unit treatment value assumption): 1. No interference between units. No spillovers. 2. Consistency. No hidden versions of treatment or control. Treatment is clearly defined.
