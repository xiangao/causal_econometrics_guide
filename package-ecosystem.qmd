...
|---|---|---|
| `dagitty` [@textor-dagitty-2016] | DAG and ADMG construction, adjustment-set search, d-separation | Identification, DAG workflow, Smoking cessation |
| `ggdag` | Visual rendering of DAGs/ADMGs built with `dagitty` | Identification, DAG workflow, IV/RDD |
| `causaleffect` [@tikka-hyttinen-karvanen-2019] | Pearl–Shpitser ID algorithm for general ADMGs | DAG workflow |
