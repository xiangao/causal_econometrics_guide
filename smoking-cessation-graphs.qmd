...
The graph is written and queried with `dagitty` [@textor-dagitty-2016], applying Pearl's backdoor criterion [-@pearl1995].
...
The estimator is that of Robins, Rotnitzky and Zhao [-@robins-rotnitzky-zhao-1994]. The NHEFS analysis it mirrors is Hernán and Robins [-@hernan-robins-2020].
...
The sensitivity parameters are those of Cinelli and Hazlett [-@cinelli-hazlett-2020].
